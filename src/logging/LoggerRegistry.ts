...
/**
 * The LoggerRegistry class is responsible for managing a collection of loggers 
 * within the VS Code extension. It ensures that each logger is uniquely identified 
 * and prevents the creation of duplicate loggers.
 * 
 * Key Features:
 * - Adds and removes loggers by name or channel name.
 * - Retrieves loggers for easy access.
